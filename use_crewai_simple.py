...
if "OPENAI_API_KEY" not in os.environ or not os.environ["OPENAI_API_KEY"]:
    ...
    print("Please enter your OpenAI API key directly (do NOT include 'set' or other commands).")
    print("Example format: sk-abcdefghijklmnopqrstuvwxyz123456789")
    api_key = input("Enter your OpenAI API key to continue (or press Enter to skip running the crew): ")
    if api_key:
        # Clean the API key by removing any command prefixes or quotes
        ...
        print(f"API key set (first 5 chars: {api_key[:5]}...)")
