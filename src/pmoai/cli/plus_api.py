...
from pmoai.cli.version import get_pmoai_version


class PlusAPI:
    """
    This class exposes methods for working with the PMOAI+ API.
    """

    TOOLS_RESOURCE = "/pmoai_plus/api/v1/tools"
    CREWS_RESOURCE = "/pmoai_plus/api/v1/crews"
    ...
    def __init__(self, api_key: str) -> None:
        ...
        self.headers = {
            ...
            "User-Agent": f"PMOAI-CLI/{get_pmoai_version()}",
            "X-PMOAI-Version": get_pmoai_version(),
        }
        self.base_url = getenv("PMOAI_BASE_URL", "https://app.pmoai.com")
