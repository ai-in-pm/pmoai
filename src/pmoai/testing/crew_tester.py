...
class CrewTestCase(BaseModel):
    """Represents a test case for a crew."""
...
class CrewTestResult(BaseModel):
    """Represents the result of a crew test."""
    
    test_case: CrewTestCase = Field(description="The test case that was executed.")
...
class CrewTester(BaseModel):
    """Tests crews with various test cases."""
    
    def test_crew(
        self, crew: Crew, test_cases: List[CrewTestCase]
    ) -> List[CrewTestResult]:
        """Test a crew with a list of test cases.
        
        Args:
            crew: The crew to test.
        ...
        for test_case in test_cases:
            result = self._run_test_case(crew, test_case)
            results.append(result)
        
        return results
    
    def _run_test_case(self, crew: Crew, test_case: CrewTestCase) -> CrewTestResult:
        """Run a single test case for a crew.
        ...
        # Execute the crew and measure execution time
    ...
    def _check_test_result(self, test_case: CrewTestCase, actual_output: Any) -> bool:
    ...
    def generate_report(self, results: List[CrewTestResult]) -> str:
